...
func DecodeIsoAcknowledgement(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for IsoAcknowledgement-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for IsoAcknowledgement-Repeating2, ran out of parameters but data remains")
    }
func DecodeIsoRequest(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for IsoRequest-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for IsoRequest-Repeating2, ran out of parameters but data remains")
    }
func DecodeIsoTransportProtocolDataTransfer(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for IsoTransportProtocolDataTransfer-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for IsoTransportProtocolDataTransfer-Repeating2, ran out of parameters but data remains")
    }
func DecodeIsoTransportProtocolConnectionManagementRequestToSend(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for IsoTransportProtocolConnectionManagementRequestToSend-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for IsoTransportProtocolConnectionManagementRequestToSend-Repeating2, ran out of parameters but data remains")
    }
func DecodeIsoTransportProtocolConnectionManagementClearToSend(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for IsoTransportProtocolConnectionManagementClearToSend-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for IsoTransportProtocolConnectionManagementClearToSend-Repeating2, ran out of parameters but data remains")
    }
func DecodeIsoTransportProtocolConnectionManagementEndOfMessage(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for IsoTransportProtocolConnectionManagementEndOfMessage-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for IsoTransportProtocolConnectionManagementEndOfMessage-Repeating2, ran out of parameters but data remains")
    }
func DecodeIsoTransportProtocolConnectionManagementBroadcastAnnounce(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for IsoTransportProtocolConnectionManagementBroadcastAnnounce-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for IsoTransportProtocolConnectionManagementBroadcastAnnounce-Repeating2, ran out of parameters but data remains")
    }
func DecodeIsoTransportProtocolConnectionManagementAbort(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for IsoTransportProtocolConnectionManagementAbort-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for IsoTransportProtocolConnectionManagementAbort-Repeating2, ran out of parameters but data remains")
    }
func DecodeIsoAddressClaim(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for IsoAddressClaim-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for IsoAddressClaim-Repeating2, ran out of parameters but data remains")
    }
func DecodeBus1PhaseCBasicAcQuantities(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for Bus1PhaseCBasicAcQuantities-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for Bus1PhaseCBasicAcQuantities-Repeating2, ran out of parameters but data remains")
    }
func DecodeBus1PhaseBBasicAcQuantities(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for Bus1PhaseBBasicAcQuantities-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for Bus1PhaseBBasicAcQuantities-Repeating2, ran out of parameters but data remains")
    }
func DecodeBus1PhaseABasicAcQuantities(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for Bus1PhaseABasicAcQuantities-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for Bus1PhaseABasicAcQuantities-Repeating2, ran out of parameters but data remains")
    }
func DecodeUtilityPhaseCAcReactivePower(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for UtilityPhaseCAcReactivePower-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for UtilityPhaseCAcReactivePower-Repeating2, ran out of parameters but data remains")
    }
func DecodeUtilityPhaseCAcPower(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for UtilityPhaseCAcPower-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for UtilityPhaseCAcPower-Repeating2, ran out of parameters but data remains")
    }
func DecodeUtilityPhaseCBasicAcQuantities(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for UtilityPhaseCBasicAcQuantities-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for UtilityPhaseCBasicAcQuantities-Repeating2, ran out of parameters but data remains")
    }
func DecodeUtilityPhaseBAcReactivePower(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for UtilityPhaseBAcReactivePower-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for UtilityPhaseBAcReactivePower-Repeating2, ran out of parameters but data remains")
    }
func DecodeUtilityPhaseBAcPower(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for UtilityPhaseBAcPower-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for UtilityPhaseBAcPower-Repeating2, ran out of parameters but data remains")
    }
func DecodeUtilityPhaseBBasicAcQuantities(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for UtilityPhaseBBasicAcQuantities-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for UtilityPhaseBBasicAcQuantities-Repeating2, ran out of parameters but data remains")
    }
func DecodeUtilityPhaseAAcReactivePower(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for UtilityPhaseAAcReactivePower-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for UtilityPhaseAAcReactivePower-Repeating2, ran out of parameters but data remains")
    }
func DecodeUtilityPhaseAAcPower(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for UtilityPhaseAAcPower-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for UtilityPhaseAAcPower-Repeating2, ran out of parameters but data remains")
    }
func DecodeUtilityPhaseABasicAcQuantities(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for UtilityPhaseABasicAcQuantities-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for UtilityPhaseABasicAcQuantities-Repeating2, ran out of parameters but data remains")
    }
func DecodeUtilityTotalAcReactivePower(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for UtilityTotalAcReactivePower-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for UtilityTotalAcReactivePower-Repeating2, ran out of parameters but data remains")
    }
func DecodeUtilityTotalAcPower(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for UtilityTotalAcPower-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for UtilityTotalAcPower-Repeating2, ran out of parameters but data remains")
    }
func DecodeUtilityAverageBasicAcQuantities(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for UtilityAverageBasicAcQuantities-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for UtilityAverageBasicAcQuantities-Repeating2, ran out of parameters but data remains")
    }
func DecodeGeneratorPhaseCAcReactivePower(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for GeneratorPhaseCAcReactivePower-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for GeneratorPhaseCAcReactivePower-Repeating2, ran out of parameters but data remains")
    }
func DecodeGeneratorPhaseCAcPower(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for GeneratorPhaseCAcPower-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for GeneratorPhaseCAcPower-Repeating2, ran out of parameters but data remains")
    }
func DecodeGeneratorPhaseCBasicAcQuantities(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for GeneratorPhaseCBasicAcQuantities-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for GeneratorPhaseCBasicAcQuantities-Repeating2, ran out of parameters but data remains")
    }
func DecodeGeneratorPhaseBAcReactivePower(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for GeneratorPhaseBAcReactivePower-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for GeneratorPhaseBAcReactivePower-Repeating2, ran out of parameters but data remains")
    }
func DecodeGeneratorPhaseBAcPower(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for GeneratorPhaseBAcPower-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for GeneratorPhaseBAcPower-Repeating2, ran out of parameters but data remains")
    }
func DecodeGeneratorPhaseBBasicAcQuantities(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for GeneratorPhaseBBasicAcQuantities-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for GeneratorPhaseBBasicAcQuantities-Repeating2, ran out of parameters but data remains")
    }
func DecodeGeneratorPhaseAAcReactivePower(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for GeneratorPhaseAAcReactivePower-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for GeneratorPhaseAAcReactivePower-Repeating2, ran out of parameters but data remains")
    }
func DecodeGeneratorPhaseAAcPower(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for GeneratorPhaseAAcPower-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for GeneratorPhaseAAcPower-Repeating2, ran out of parameters but data remains")
    }
func DecodeGeneratorPhaseABasicAcQuantities(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for GeneratorPhaseABasicAcQuantities-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for GeneratorPhaseABasicAcQuantities-Repeating2, ran out of parameters but data remains")
    }
func DecodeGeneratorTotalAcReactivePower(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for GeneratorTotalAcReactivePower-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for GeneratorTotalAcReactivePower-Repeating2, ran out of parameters but data remains")
    }
func DecodeGeneratorTotalAcPower(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for GeneratorTotalAcPower-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for GeneratorTotalAcPower-Repeating2, ran out of parameters but data remains")
    }
func DecodeGeneratorAverageBasicAcQuantities(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for GeneratorAverageBasicAcQuantities-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for GeneratorAverageBasicAcQuantities-Repeating2, ran out of parameters but data remains")
    }
func DecodeIsoCommandedAddress(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for IsoCommandedAddress-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for IsoCommandedAddress-Repeating2, ran out of parameters but data remains")
    }
func DecodeMaretronProprietaryDcBreakerCurrent(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for MaretronProprietaryDcBreakerCurrent-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for MaretronProprietaryDcBreakerCurrent-Repeating2, ran out of parameters but data remains")
    }
func DecodeAirmarBootStateAcknowledgment(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AirmarBootStateAcknowledgment-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AirmarBootStateAcknowledgment-Repeating2, ran out of parameters but data remains")
    }
func DecodeLowranceTemperature(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for LowranceTemperature-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for LowranceTemperature-Repeating2, ran out of parameters but data remains")
    }
func DecodeAirmarBootStateRequest(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AirmarBootStateRequest-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AirmarBootStateRequest-Repeating2, ran out of parameters but data remains")
    }
func DecodeAirmarAccessLevel(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AirmarAccessLevel-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AirmarAccessLevel-Repeating2, ran out of parameters but data remains")
    }
func DecodeSimnetDeviceStatus(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for SimnetDeviceStatus-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for SimnetDeviceStatus-Repeating2, ran out of parameters but data remains")
    }
func DecodeSimnetDeviceStatusRequest(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for SimnetDeviceStatusRequest-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for SimnetDeviceStatusRequest-Repeating2, ran out of parameters but data remains")
    }
func DecodeSimnetPilotMode(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for SimnetPilotMode-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for SimnetPilotMode-Repeating2, ran out of parameters but data remains")
    }
func DecodeSimnetDeviceModeRequest(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for SimnetDeviceModeRequest-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for SimnetDeviceModeRequest-Repeating2, ran out of parameters but data remains")
    }
func DecodeSeatalkPilotLockedHeading(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for SeatalkPilotLockedHeading-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for SeatalkPilotLockedHeading-Repeating2, ran out of parameters but data remains")
    }
func DecodeSeatalkSilenceAlarm(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for SeatalkSilenceAlarm-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for SeatalkSilenceAlarm-Repeating2, ran out of parameters but data remains")
    }
func DecodeAirmarSpeedPulseCount(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AirmarSpeedPulseCount-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AirmarSpeedPulseCount-Repeating2, ran out of parameters but data remains")
    }
func DecodeNmeaRequestGroupFunction(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if v, err := ReadScaled[float32](stream, val.GetFieldSpec("TransmissionInterval")); err != nil {
        return nil, fmt.Errorf("parse failed for NmeaRequestGroupFunction-TransmissionInterval: %w", err)
    } else {
        val.TransmissionInterval = v
    }
    if v, err := ReadScaled[float32](stream, val.GetFieldSpec("TransmissionIntervalOffset")); err != nil {
    ...
    if v, err := ReadRaw[uint8](stream, val.GetFieldSpec("NumberOfParameters")); err != nil {
    ...
    for {
        ...
        if v, err := ReadRaw[uint8](stream, val.GetFieldSpec("Parameter")); err != nil {
            return nil, fmt.Errorf("parse failed for NmeaRequestGroupFunction-Parameter: %w", err)
        } else {
            rep.Parameter = v
        }
        if v, err := stream.readVariableDataWithSpec(val.GetFieldSpec("Value")); err != nil {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for NmeaRequestGroupFunction-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for NmeaRequestGroupFunction-Repeating2, ran out of parameters but data remains")
    }
func DecodeNmeaCommandGroupFunction(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for NmeaCommandGroupFunction-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for NmeaCommandGroupFunction-Repeating2, ran out of parameters but data remains")
    }
func DecodeNmeaAcknowledgeGroupFunction(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for NmeaAcknowledgeGroupFunction-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for NmeaAcknowledgeGroupFunction-Repeating2, ran out of parameters but data remains")
    }
func DecodeNmeaReadFieldsReplyGroupFunction(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if v, err := ReadRaw[uint8](stream, val.GetFieldSpec("UniqueId")); err != nil {
        return nil, fmt.Errorf("parse failed for NmeaReadFieldsReplyGroupFunction-UniqueId: %w", err)
    } else {
        val.UniqueId = v
    }
    if v, err := ReadRaw[uint8](stream, val.GetFieldSpec("NumberOfSelectionPairs")); err != nil {
    ...
    for {
        ...
        if v, err := ReadRaw[uint8](stream, val.GetFieldSpec("SelectionParameter")); err != nil {
            return nil, fmt.Errorf("parse failed for NmeaReadFieldsReplyGroupFunction-SelectionParameter: %w", err)
        } else {
            rep.SelectionParameter = v
        }
        if v, err := stream.readVariableDataWithSpec(val.GetFieldSpec("SelectionValue")); err != nil {
        ...
        if repeat2Count == 0 {
            if stream.isEOF() {
                ...
                return nil, fmt.Errorf("parse failed for NmeaReadFieldsReplyGroupFunction-Repeating1, ran out of parameters but data remains")
            }
        }
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for NmeaReadFieldsReplyGroupFunction-Repeating2, ran out of parameters but data remains")
    }
func DecodeNmeaWriteFieldsGroupFunction(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    for {
        ...
        if repeat2Count == 0 {
            if stream.isEOF() {
                ...
                return nil, fmt.Errorf("parse failed for NmeaWriteFieldsGroupFunction-Repeating1, ran out of parameters but data remains")
            }
        }
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for NmeaWriteFieldsGroupFunction-Repeating2, ran out of parameters but data remains")
    }
func DecodeNmeaWriteFieldsReplyGroupFunction(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    for {
        ...
        if repeat2Count == 0 {
            if stream.isEOF() {
                ...
                return nil, fmt.Errorf("parse failed for NmeaWriteFieldsReplyGroupFunction-Repeating1, ran out of parameters but data remains")
            }
        }
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for NmeaWriteFieldsReplyGroupFunction-Repeating2, ran out of parameters but data remains")
    }
func DecodePgnListTransmitAndReceive(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for PgnListTransmitAndReceive-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for PgnListTransmitAndReceive-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionMediaControl(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionMediaControl-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionMediaControl-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionSiriusControl(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionSiriusControl-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionSiriusControl-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionRequestStatus(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionRequestStatus-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionRequestStatus-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionSetSource(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionSetSource-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionSetSource-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionSetMute(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionSetMute-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionSetMute-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionSetZoneVolume(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionSetZoneVolume-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionSetZoneVolume-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionSetAllVolumes(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionSetAllVolumes-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionSetAllVolumes-Repeating2, ran out of parameters but data remains")
    }
func DecodeAirmarAttitudeOffset(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AirmarAttitudeOffset-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AirmarAttitudeOffset-Repeating2, ran out of parameters but data remains")
    }
func DecodeAirmarSimulateMode(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AirmarSimulateMode-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AirmarSimulateMode-Repeating2, ran out of parameters but data remains")
    }
func DecodeAirmarCalibrateDepth(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AirmarCalibrateDepth-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AirmarCalibrateDepth-Repeating2, ran out of parameters but data remains")
    }
func DecodeAirmarCalibrateSpeed(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AirmarCalibrateSpeed-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AirmarCalibrateSpeed-Repeating2, ran out of parameters but data remains")
    }
func DecodeAirmarCalibrateTemperature(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AirmarCalibrateTemperature-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AirmarCalibrateTemperature-Repeating2, ran out of parameters but data remains")
    }
func DecodeAirmarSpeedFilterNone(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AirmarSpeedFilterNone-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AirmarSpeedFilterNone-Repeating2, ran out of parameters but data remains")
    }
func DecodeAirmarSpeedFilterIir(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AirmarSpeedFilterIir-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AirmarSpeedFilterIir-Repeating2, ran out of parameters but data remains")
    }
func DecodeAirmarTemperatureFilterNone(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AirmarTemperatureFilterNone-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AirmarTemperatureFilterNone-Repeating2, ran out of parameters but data remains")
    }
func DecodeAirmarTemperatureFilterIir(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AirmarTemperatureFilterIir-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AirmarTemperatureFilterIir-Repeating2, ran out of parameters but data remains")
    }
func DecodeAirmarNmea2000Options(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AirmarNmea2000Options-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AirmarNmea2000Options-Repeating2, ran out of parameters but data remains")
    }
func DecodeMaretronDeviationCalibrationResponse(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for MaretronDeviationCalibrationResponse-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for MaretronDeviationCalibrationResponse-Repeating2, ran out of parameters but data remains")
    }
func DecodeMaretronSlaveResponse(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for MaretronSlaveResponse-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for MaretronSlaveResponse-Repeating2, ran out of parameters but data remains")
    }
func DecodeAlert(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for Alert-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for Alert-Repeating2, ran out of parameters but data remains")
    }
func DecodeAlertResponse(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AlertResponse-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AlertResponse-Repeating2, ran out of parameters but data remains")
    }
func DecodeAlertText(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AlertText-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AlertText-Repeating2, ran out of parameters but data remains")
    }
func DecodeSystemTime(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for SystemTime-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for SystemTime-Repeating2, ran out of parameters but data remains")
    }
func DecodeHeartbeat(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for Heartbeat-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for Heartbeat-Repeating2, ran out of parameters but data remains")
    }
func DecodeProductInformation(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for ProductInformation-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for ProductInformation-Repeating2, ran out of parameters but data remains")
    }
func DecodeConfigurationInformation(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for ConfigurationInformation-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for ConfigurationInformation-Repeating2, ran out of parameters but data remains")
    }
func DecodeManOverboardNotification(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for ManOverboardNotification-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for ManOverboardNotification-Repeating2, ran out of parameters but data remains")
    }
func DecodeHeadingTrackControl(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for HeadingTrackControl-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for HeadingTrackControl-Repeating2, ran out of parameters but data remains")
    }
func DecodeRudder(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for Rudder-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for Rudder-Repeating2, ran out of parameters but data remains")
    }
func DecodeVesselHeading(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for VesselHeading-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for VesselHeading-Repeating2, ran out of parameters but data remains")
    }
func DecodeRateOfTurn(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for RateOfTurn-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for RateOfTurn-Repeating2, ran out of parameters but data remains")
    }
func DecodeAttitude(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for Attitude-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for Attitude-Repeating2, ran out of parameters but data remains")
    }
func DecodeMagneticVariation(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for MagneticVariation-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for MagneticVariation-Repeating2, ran out of parameters but data remains")
    }
func DecodeEngineParametersRapidUpdate(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for EngineParametersRapidUpdate-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for EngineParametersRapidUpdate-Repeating2, ran out of parameters but data remains")
    }
func DecodeEngineParametersDynamic(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for EngineParametersDynamic-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for EngineParametersDynamic-Repeating2, ran out of parameters but data remains")
    }
func DecodeTransmissionParametersDynamic(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for TransmissionParametersDynamic-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for TransmissionParametersDynamic-Repeating2, ran out of parameters but data remains")
    }
func DecodeTripParametersVessel(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for TripParametersVessel-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for TripParametersVessel-Repeating2, ran out of parameters but data remains")
    }
func DecodeTripParametersEngine(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for TripParametersEngine-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for TripParametersEngine-Repeating2, ran out of parameters but data remains")
    }
func DecodeEngineParametersStatic(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for EngineParametersStatic-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for EngineParametersStatic-Repeating2, ran out of parameters but data remains")
    }
func DecodeLoadControllerConnectionStateControl(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for LoadControllerConnectionStateControl-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for LoadControllerConnectionStateControl-Repeating2, ran out of parameters but data remains")
    }
func DecodeBinarySwitchBankStatus(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for BinarySwitchBankStatus-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for BinarySwitchBankStatus-Repeating2, ran out of parameters but data remains")
    }
func DecodeSwitchBankControl(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for SwitchBankControl-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for SwitchBankControl-Repeating2, ran out of parameters but data remains")
    }
func DecodeAcInputStatus(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AcInputStatus-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AcInputStatus-Repeating2, ran out of parameters but data remains")
    }
func DecodeAcOutputStatus(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AcOutputStatus-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AcOutputStatus-Repeating2, ran out of parameters but data remains")
    }
func DecodeFluidLevel(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FluidLevel-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FluidLevel-Repeating2, ran out of parameters but data remains")
    }
func DecodeDcDetailedStatus(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for DcDetailedStatus-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for DcDetailedStatus-Repeating2, ran out of parameters but data remains")
    }
func DecodeChargerStatus(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for ChargerStatus-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for ChargerStatus-Repeating2, ran out of parameters but data remains")
    }
func DecodeBatteryStatus(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for BatteryStatus-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for BatteryStatus-Repeating2, ran out of parameters but data remains")
    }
func DecodeInverterStatus(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for InverterStatus-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for InverterStatus-Repeating2, ran out of parameters but data remains")
    }
func DecodeAcPowerCurrentPhaseA(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AcPowerCurrentPhaseA-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AcPowerCurrentPhaseA-Repeating2, ran out of parameters but data remains")
    }
func DecodeAcPowerCurrentPhaseB(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AcPowerCurrentPhaseB-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AcPowerCurrentPhaseB-Repeating2, ran out of parameters but data remains")
    }
func DecodeAcPowerCurrentPhaseC(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AcPowerCurrentPhaseC-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AcPowerCurrentPhaseC-Repeating2, ran out of parameters but data remains")
    }
func DecodeAcVoltageFrequencyPhaseA(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AcVoltageFrequencyPhaseA-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AcVoltageFrequencyPhaseA-Repeating2, ran out of parameters but data remains")
    }
func DecodeAcVoltageFrequencyPhaseB(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AcVoltageFrequencyPhaseB-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AcVoltageFrequencyPhaseB-Repeating2, ran out of parameters but data remains")
    }
func DecodeAcVoltageFrequencyPhaseC(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AcVoltageFrequencyPhaseC-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AcVoltageFrequencyPhaseC-Repeating2, ran out of parameters but data remains")
    }
func DecodeConverterStatus(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for ConverterStatus-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for ConverterStatus-Repeating2, ran out of parameters but data remains")
    }
func DecodeDcVoltageCurrent(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for DcVoltageCurrent-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for DcVoltageCurrent-Repeating2, ran out of parameters but data remains")
    }
func DecodeLeewayAngle(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for LeewayAngle-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for LeewayAngle-Repeating2, ran out of parameters but data remains")
    }
func DecodeThrusterControlStatus(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for ThrusterControlStatus-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for ThrusterControlStatus-Repeating2, ran out of parameters but data remains")
    }
func DecodeThrusterInformation(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for ThrusterInformation-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for ThrusterInformation-Repeating2, ran out of parameters but data remains")
    }
func DecodeThrusterMotorStatus(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for ThrusterMotorStatus-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for ThrusterMotorStatus-Repeating2, ran out of parameters but data remains")
    }
func DecodeSpeed(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for Speed-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for Speed-Repeating2, ran out of parameters but data remains")
    }
func DecodeWaterDepth(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for WaterDepth-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for WaterDepth-Repeating2, ran out of parameters but data remains")
    }
func DecodeDistanceLog(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for DistanceLog-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for DistanceLog-Repeating2, ran out of parameters but data remains")
    }
func DecodeWindlassControlStatus(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for WindlassControlStatus-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for WindlassControlStatus-Repeating2, ran out of parameters but data remains")
    }
func DecodeAnchorWindlassOperatingStatus(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AnchorWindlassOperatingStatus-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AnchorWindlassOperatingStatus-Repeating2, ran out of parameters but data remains")
    }
func DecodeAnchorWindlassMonitoringStatus(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AnchorWindlassMonitoringStatus-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AnchorWindlassMonitoringStatus-Repeating2, ran out of parameters but data remains")
    }
func DecodePositionRapidUpdate(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for PositionRapidUpdate-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for PositionRapidUpdate-Repeating2, ran out of parameters but data remains")
    }
func DecodeCogSogRapidUpdate(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for CogSogRapidUpdate-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for CogSogRapidUpdate-Repeating2, ran out of parameters but data remains")
    }
func DecodeGnssPositionData(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for GnssPositionData-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for GnssPositionData-Repeating2, ran out of parameters but data remains")
    }
func DecodeTimeDate(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for TimeDate-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for TimeDate-Repeating2, ran out of parameters but data remains")
    }
func DecodeAisClassAPositionReport(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AisClassAPositionReport-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AisClassAPositionReport-Repeating2, ran out of parameters but data remains")
    }
func DecodeAisClassBPositionReport(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AisClassBPositionReport-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AisClassBPositionReport-Repeating2, ran out of parameters but data remains")
    }
func DecodeAisAidsToNavigationAtonReport(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AisAidsToNavigationAtonReport-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AisAidsToNavigationAtonReport-Repeating2, ran out of parameters but data remains")
    }
func DecodeDatum(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for Datum-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for Datum-Repeating2, ran out of parameters but data remains")
    }
func DecodeUserDatum(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for UserDatum-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for UserDatum-Repeating2, ran out of parameters but data remains")
    }
func DecodeCrossTrackError(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for CrossTrackError-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for CrossTrackError-Repeating2, ran out of parameters but data remains")
    }
func DecodeNavigationData(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for NavigationData-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for NavigationData-Repeating2, ran out of parameters but data remains")
    }
func DecodeNavigationRouteWpInformation(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for NavigationRouteWpInformation-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for NavigationRouteWpInformation-Repeating2, ran out of parameters but data remains")
    }
func DecodeGnssDops(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for GnssDops-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for GnssDops-Repeating2, ran out of parameters but data remains")
    }
func DecodeGnssSatsInView(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for GnssSatsInView-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for GnssSatsInView-Repeating2, ran out of parameters but data remains")
    }
func DecodeGnssRaimSettings(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for GnssRaimSettings-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for GnssRaimSettings-Repeating2, ran out of parameters but data remains")
    }
func DecodeGnssPseudorangeErrorStatistics(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for GnssPseudorangeErrorStatistics-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for GnssPseudorangeErrorStatistics-Repeating2, ran out of parameters but data remains")
    }
func DecodeDgnssCorrections(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for DgnssCorrections-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for DgnssCorrections-Repeating2, ran out of parameters but data remains")
    }
func DecodeGnssDifferentialCorrectionReceiverInterface(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for GnssDifferentialCorrectionReceiverInterface-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for GnssDifferentialCorrectionReceiverInterface-Repeating2, ran out of parameters but data remains")
    }
func DecodeGnssDifferentialCorrectionReceiverSignal(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for GnssDifferentialCorrectionReceiverSignal-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for GnssDifferentialCorrectionReceiverSignal-Repeating2, ran out of parameters but data remains")
    }
func DecodeGlonassAlmanacData(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for GlonassAlmanacData-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for GlonassAlmanacData-Repeating2, ran out of parameters but data remains")
    }
func DecodeAisClassAStaticAndVoyageRelatedData(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AisClassAStaticAndVoyageRelatedData-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AisClassAStaticAndVoyageRelatedData-Repeating2, ran out of parameters but data remains")
    }
func DecodeAisAddressedBinaryMessage(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AisAddressedBinaryMessage-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AisAddressedBinaryMessage-Repeating2, ran out of parameters but data remains")
    }
func DecodeAisAcknowledge(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AisAcknowledge-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AisAcknowledge-Repeating2, ran out of parameters but data remains")
    }
func DecodeAisBinaryBroadcastMessage(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AisBinaryBroadcastMessage-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AisBinaryBroadcastMessage-Repeating2, ran out of parameters but data remains")
    }
func DecodeRadioFrequencyModePower(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for RadioFrequencyModePower-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for RadioFrequencyModePower-Repeating2, ran out of parameters but data remains")
    }
func DecodeAisClassBStaticDataMsg24PartA(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AisClassBStaticDataMsg24PartA-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AisClassBStaticDataMsg24PartA-Repeating2, ran out of parameters but data remains")
    }
func DecodeAisClassBStaticDataMsg24PartB(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for AisClassBStaticDataMsg24PartB-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for AisClassBStaticDataMsg24PartB-Repeating2, ran out of parameters but data remains")
    }
func DecodeRouteAndWpServiceDatabaseList(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for RouteAndWpServiceDatabaseList-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for RouteAndWpServiceDatabaseList-Repeating2, ran out of parameters but data remains")
    }
func DecodeRouteAndWpServiceRouteList(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for RouteAndWpServiceRouteList-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for RouteAndWpServiceRouteList-Repeating2, ran out of parameters but data remains")
    }
func DecodeRouteAndWpServiceRouteWpListAttributes(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for RouteAndWpServiceRouteWpListAttributes-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for RouteAndWpServiceRouteWpListAttributes-Repeating2, ran out of parameters but data remains")
    }
func DecodeRouteAndWpServiceRouteWpNamePosition(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for RouteAndWpServiceRouteWpNamePosition-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for RouteAndWpServiceRouteWpNamePosition-Repeating2, ran out of parameters but data remains")
    }
func DecodeRouteAndWpServiceRouteWpName(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for RouteAndWpServiceRouteWpName-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for RouteAndWpServiceRouteWpName-Repeating2, ran out of parameters but data remains")
    }
func DecodeRouteAndWpServiceXteLimitNavigationMethod(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for RouteAndWpServiceXteLimitNavigationMethod-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for RouteAndWpServiceXteLimitNavigationMethod-Repeating2, ran out of parameters but data remains")
    }
func DecodeRouteAndWpServiceWpComment(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for RouteAndWpServiceWpComment-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for RouteAndWpServiceWpComment-Repeating2, ran out of parameters but data remains")
    }
func DecodeRouteAndWpServiceRouteComment(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for RouteAndWpServiceRouteComment-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for RouteAndWpServiceRouteComment-Repeating2, ran out of parameters but data remains")
    }
func DecodeRouteAndWpServiceDatabaseComment(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for RouteAndWpServiceDatabaseComment-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for RouteAndWpServiceDatabaseComment-Repeating2, ran out of parameters but data remains")
    }
func DecodeRouteAndWpServiceRadiusOfTurn(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for RouteAndWpServiceRadiusOfTurn-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for RouteAndWpServiceRadiusOfTurn-Repeating2, ran out of parameters but data remains")
    }
func DecodeRouteAndWpServiceWpListWpNamePosition(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for RouteAndWpServiceWpListWpNamePosition-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for RouteAndWpServiceWpListWpNamePosition-Repeating2, ran out of parameters but data remains")
    }
func DecodeWindData(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for WindData-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for WindData-Repeating2, ran out of parameters but data remains")
    }
func DecodeEnvironmentalParametersObsolete(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for EnvironmentalParametersObsolete-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for EnvironmentalParametersObsolete-Repeating2, ran out of parameters but data remains")
    }
func DecodeEnvironmentalParameters(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for EnvironmentalParameters-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for EnvironmentalParameters-Repeating2, ran out of parameters but data remains")
    }
func DecodeTemperature(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for Temperature-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for Temperature-Repeating2, ran out of parameters but data remains")
    }
func DecodeHumidity(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for Humidity-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for Humidity-Repeating2, ran out of parameters but data remains")
    }
func DecodeActualPressure(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for ActualPressure-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for ActualPressure-Repeating2, ran out of parameters but data remains")
    }
func DecodeSetPressure(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for SetPressure-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for SetPressure-Repeating2, ran out of parameters but data remains")
    }
func DecodeTemperatureExtendedRange(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for TemperatureExtendedRange-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for TemperatureExtendedRange-Repeating2, ran out of parameters but data remains")
    }
func DecodeTideStationData(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for TideStationData-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for TideStationData-Repeating2, ran out of parameters but data remains")
    }
func DecodeWatermakerInputSettingAndStatus(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for WatermakerInputSettingAndStatus-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for WatermakerInputSettingAndStatus-Repeating2, ran out of parameters but data remains")
    }
func DecodeVesselSpeedComponents(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for VesselSpeedComponents-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for VesselSpeedComponents-Repeating2, ran out of parameters but data remains")
    }
func DecodeSonichubVolume(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for SonichubVolume-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for SonichubVolume-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionVersions(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionVersions-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionVersions-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionSource(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionSource-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionSource-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionSourceCount(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionSourceCount-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionSourceCount-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionMedia(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionMedia-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionMedia-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionTrackName(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionTrackName-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionTrackName-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionArtistName(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionArtistName-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionArtistName-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionAlbumName(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionAlbumName-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionAlbumName-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionDeviceName(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionDeviceName-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionDeviceName-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionZoneName(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionZoneName-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionZoneName-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionTrackPosition(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionTrackPosition-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionTrackPosition-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionTuner(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionTuner-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionTuner-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionMarineTuner(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionMarineTuner-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionMarineTuner-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionMarineSquelch(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionMarineSquelch-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionMarineSquelch-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionMarineScanMode(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionMarineScanMode-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionMarineScanMode-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionMenuItem(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionMenuItem-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionMenuItem-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionAuxGain(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionAuxGain-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionAuxGain-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionUsbRepeatStatus(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionUsbRepeatStatus-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionUsbRepeatStatus-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionSetting(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionSetting-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionSetting-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionSettings(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionSettings-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionSettings-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionMute(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionMute-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionMute-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionBalance(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionBalance-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionBalance-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionLowPassFilter(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionLowPassFilter-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionLowPassFilter-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionSublevels(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionSublevels-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionSublevels-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionEq(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionEq-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionEq-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionVolumeLimits(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionVolumeLimits-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionVolumeLimits-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionVolumes(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionVolumes-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionVolumes-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionCapabilities(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionCapabilities-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionCapabilities-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionLineLevelControl(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionLineLevelControl-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionLineLevelControl-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionPowerState(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionPowerState-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionPowerState-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionSiriusxm(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionSiriusxm-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionSiriusxm-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionSiriusxmChannel(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionSiriusxmChannel-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionSiriusxmChannel-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionSiriusxmTitle(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionSiriusxmTitle-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionSiriusxmTitle-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionSiriusxmArtist(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionSiriusxmArtist-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionSiriusxmArtist-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionSiriusxmContentInfo(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionSiriusxmContentInfo-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionSiriusxmContentInfo-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionSiriusxmCategory(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionSiriusxmCategory-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionSiriusxmCategory-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionSiriusxmSignal(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionSiriusxmSignal-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionSiriusxmSignal-Repeating2, ran out of parameters but data remains")
    }
func DecodeFusionSiriusxmPresets(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for FusionSiriusxmPresets-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for FusionSiriusxmPresets-Repeating2, ran out of parameters but data remains")
    }
func DecodeMaretronProprietaryTemperatureHighRange(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for MaretronProprietaryTemperatureHighRange-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for MaretronProprietaryTemperatureHighRange-Repeating2, ran out of parameters but data remains")
    }
func DecodeBGKeyValueData(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for BGKeyValueData-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for BGKeyValueData-Repeating2, ran out of parameters but data remains")
    }
func DecodeMaretronSwitchStatusCounter(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for MaretronSwitchStatusCounter-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for MaretronSwitchStatusCounter-Repeating2, ran out of parameters but data remains")
    }
func DecodeMaretronSwitchStatusTimer(Info MessageInfo, stream *DataStream) (any, error) {
    ...
    if stream.isEOF() {
        ...
        return nil, fmt.Errorf("parse failed for MaretronSwitchStatusTimer-Repeating1, ran out of parameters but data remains")
    }
    if stream.isEOF() {
        return val, nil
    } else {
        return nil, fmt.Errorf("parse failed for MaretronSwitchStatusTimer-Repeating2, ran out of parameters but data remains")
    }
