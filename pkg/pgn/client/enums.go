...
default:
		return fmt.Sprintf("%s(%d)", "OffOnControlConst", int(e))
	}
}
...
func (e SeatalkSharedConst) String() string {
	switch e {
		...
		case 2:
			return "Not Shared"
default:
		return fmt.Sprintf("%s(%d)", "SeatalkSharedConst", int(e))
	}
}
...
func (e FusionPlayStatusConst) String() string {
	switch e {
		...
		case 5:
			return "Skip Rewind"
default:
		return fmt.Sprintf("%s(%d)", "FusionPlayStatusConst", int(e))
	}
}
...
func (e FusionSourceTypeConst) String() string {
	switch e {
		...
		case 17:
			return "Unknown"
default:
		return fmt.Sprintf("%s(%d)", "FusionSourceTypeConst", int(e))
	}
}
...
func (e FusionSiriusComStateConst) String() string {
	switch e {
		...
		case 3:
			return "On"
default:
		return fmt.Sprintf("%s(%d)", "FusionSiriusComStateConst", int(e))
	}
}
...
default:
		return fmt.Sprintf("%s(%d)", "FusionSiriusAlertConst", int(e))
	}
}
...
func (e FusionSiriusTuningModeConst) String() string {
	switch e {
		...
		case 3:
			return "Preset"
default:
		return fmt.Sprintf("%s(%d)", "FusionSiriusTuningModeConst", int(e))
	}
}
...
func (e FusionStatusMessageIdConst) String() string {
	switch e {
		...
		case 32813:
			return "Zone Name"
default:
		return fmt.Sprintf("%s(%d)", "FusionStatusMessageIdConst", int(e))
	}
}
...
func (e FusionSettingConst) String() string {
	switch e {
		...
		case 77:
			return "Null Setting"
default:
		return fmt.Sprintf("%s(%d)", "FusionSettingConst", int(e))
	}
}
...
func (e FusionRepeatStatusConst) String() string {
	switch e {
		...
		case 2:
			return "All/album"
default:
		return fmt.Sprintf("%s(%d)", "FusionRepeatStatusConst", int(e))
	}
}
...
func (e WpPositionResolutionConst) String() string {
	switch e {
		...
		case 4:
			return "<0 .. 0.0001] min"
default:
		return fmt.Sprintf("%s(%d)", "WpPositionResolutionConst", int(e))
	}
}
...
default:
		return fmt.Sprintf("%s(%d)", "WpIdentificationMethodConst", int(e))
	}
}
...
func (e WpRouteStatusConst) String() string {
	switch e {
		...
		case 2:
			return "Deleted"
default:
		return fmt.Sprintf("%s(%d)", "WpRouteStatusConst", int(e))
	}
}
...
func (e WpNavigationMethodConst) String() string {
	switch e {
		...
		case 1:
			return "Rhumb Line"
default:
		return fmt.Sprintf("%s(%d)", "WpNavigationMethodConst", int(e))
	}
}
...
default:
		return fmt.Sprintf("%s(%d)", "InverterModeConst", int(e))
	}
}
...
func (e CertificationLevelConst) String() string {
	switch e {
		...
		case 1:
			return "Level B"
default:
		return fmt.Sprintf("%s(%d)", "CertificationLevelConst", int(e))
	}
}
...
func (e AgsModeConst) String() string {
	switch e {
		...
		case 2:
			return "Automatic"
default:
		return fmt.Sprintf("%s(%d)", "AgsModeConst", int(e))
	}
}
...
default:
		return fmt.Sprintf("%s(%d)", "AgsOperatingStateConst", int(e))
	}
}
...
func (e AgsGeneratingStateConst) String() string {
	switch e {
		...
		case 11:
			return "Crank delaty"
default:
		return fmt.Sprintf("%s(%d)", "AgsGeneratingStateConst", int(e))
	}
}
...
default:
		return fmt.Sprintf("%s(%d)", "AgsOnReasonConst", int(e))
	}
}
...
default:
		return fmt.Sprintf("%s(%d)", "AgsOffReasonConst", int(e))
	}
}
...
default:
		return fmt.Sprintf("%s(%d)", "TelephoneModeConst", int(e))
	}
}
...
func (e PowerModeConst) String() string {
	switch e {
		...
		case 1:
			return "Low"
default:
		return fmt.Sprintf("%s(%d)", "PowerModeConst", int(e))
	}
}
...
default:
		return fmt.Sprintf("%s(%d)", "BroadcastIndicatorConst", int(e))
	}
}
...
func (e BandwidthConst) String() string {
	switch e {
		...
		case 1:
			return "12.5 kHz"
default:
		return fmt.Sprintf("%s(%d)", "BandwidthConst", int(e))
	}
}
...
func (e FloodStateConst) String() string {
	switch e {
		...
		case 2:
			return "Ebb"
default:
		return fmt.Sprintf("%s(%d)", "FloodStateConst", int(e))
	}
}
...
func (e AcLineConst) String() string {
	switch e {
		...
		case 2:
			return "Line 3"
default:
		return fmt.Sprintf("%s(%d)", "AcLineConst", int(e))
	}
}
...
func (e ZoneSizeConst) String() string {
	switch e {
		...
		case 5:
			return "6 nm"
default:
		return fmt.Sprintf("%s(%d)", "ZoneSizeConst", int(e))
	}
}
...
func (e MaretronProductCodeConst) String() string {
	switch e {
		...
		case 2686:
			return "SSC300"
default:
		return fmt.Sprintf("%s(%d)", "MaretronProductCodeConst", int(e))
	}
}
...
func (e MaretronSoftwareCodeConst) String() string {
	switch e {
		case 1:
			return "Version 1"
default:
		return fmt.Sprintf("%s(%d)", "MaretronSoftwareCodeConst", int(e))
	}
}
...
default:
		return fmt.Sprintf("%s(%d)", "MaretronCommandConst", int(e))
	}
}
...
default:
		return fmt.Sprintf("%s(%d)", "MaretronStatusDeviationConst", int(e))
	}
}
...
func (e AutomaticManualConst) String() string {
	switch e {
		...
		case 1:
			return "Manual"
default:
		return fmt.Sprintf("%s(%d)", "AutomaticManualConst", int(e))
	}
}
...
func (e SbasSvConst) String() string {
	switch e {
		...
		case 18:
			return "138"
default:
		return fmt.Sprintf("%s(%d)", "SbasSvConst", int(e))
	}
}
...
var SimnetKeyValueConstMap = map[int]string{0: "Heading Offset",
	41: "Timezone offset",
	260: "True wind high",
	264: "Deep water",
	516: "True wind low",
	...
	1024: "Field angle",
	1800: "Anchor depth",
	4863: "Backlight level",
	5160: "Time format",
	5161: "Time hour display",
	9983: "Night mode",
	11524: "True wind shift",
	22296: "AP low boat speed",
	32789: "Alert bits",
	44079: "Night mode color",
	55087: "Day mode invert",
	 
}


type BandgKeyValueConst uint16
var BandgKeyValueConstMap = map[int]string{0: "Altitude",
	11: "Rudder Angle",
	16: "User 5",
	17: "User 6",
	18: "User 7",
	...
	26: "User 15",
	27: "User 16",
	28: "Outside Temperature",
	29: "Outside Temperature",
	30: "Water Temperature",
	31: "Water Temperature",
	50: "Tacking Performance",
	52: "Attitude Roll",
	53: "Optimum Wind Angle",
	56: "User 1",
	57: "User 2",
	58: "User 3",
	59: "User 4",
	...
	64: "Forestay",
	65: "Water Speed",
	77: "Wind Speed Apparent",
	79: "Wind Speed Apparent",
	80: "Average True Wind Direction",
	81: "Wind Angle Apparent",
	83: "Target TWA",
	85: "Wind Speed True",
	86: "Wind Speed True",
	89: "Wind Angle True",
	...
	102: "Keel Angle",
	103: "Canard Angle",
	104: "Keel Trim Tab Angle",
	105: "Course",
	109: "Wind Direction",
	111: "Next Leg AWA",
	113: "Next Leg AWS",
	117: "Race Timer",
	124: "Polar Performance",
	125: "Target Boat Speed",
	126: "Polar Speed",
	127: "VMG to Wind",
	129: "DR Distance",
	130: "Leeway Angle",
	131: "Current Drift",
	132: "Current Set",
	135: "Barometric Pressure",
	152: "Distance to Start Line",
	154: "Heading on Opposite Tack",
	155: "Attitude Pitch",
	156: "Mast Angle",
	157: "Wind Angle to Mast",
	158: "Pitch Angle",
	163: "Daggerboard Position",
	164: "Boom Position",
	185: "MOB DR Bearing",
	186: "MOB DR Range",
	194: "Depth",
	...
	207: "Trip Distance",
	211: "DR Bearing",
	233: "Course Over Ground",
	235: "Speed Over Ground",
	239: "Remote 0",
	240: "Remote 1",
	241: "Remote 2",
	242: "Remote 3",
	...
	248: "Remote 9",
	256: "Layline Time",
	258: "Layline Distance",
	259: "Layline Distance",
	260: "Sailing Time to Waypoint",
	261: "Sailing Distance to Waypoint",
	262: "Sailing ETA",
	265: "Trip Time",
	270: "Bow Latitude",
	271: "Bow Longitude",
	272: "Start Line Bearing",
	273: "Start Line Bias",
	274: "Distance to Start Line Port",
	275: "Distance to Start Line Starboard",
	280: "Bias Advantage in Boat Lengths",
	281: "Distance to Start Line in Boat Lengths",
	282: "Backstay",
	283: "Boom Vang",
	284: "Chain Length",
	285: "VMG Performance",
	286: "Inner Forestay Load",
	287: "Inner Forestay Halyard Load",
	288: "Jib Furl",
	289: "Jib Halyard Load",
	290: "Outhaul Load",
	291: "Plow Angle",
	292: "Cunningham",
	293: "Jacuzzi Temperature",
	294: "Pool Temperature",
	296: "Keel Draught",
	297: "Boom Angle",
	298: "Code Zero Load",
	301: "Distance Behind Start Line",
	302: "Distance Behind Start Line in Boat Lengths",
	305: "Bias Advantage",
	306: "Opposite Tack COG",
	307: "Opposite Tack Target Heading",
	308: "Mast Rake",
	309: "Next Leg Bearing",
	310: "Next Leg Target Speed",
	311: "Ground Wind Direction",
	312: "Ground Wind Speed",
	313: "Mast Cant Angle",
	314: "Rudder Toe In",
	315: "Daggerboard Port",
	316: "Daggerboard Starboard",
	317: "User 17",
	318: "User 18",
	319: "User 19",
	320: "User 20",
	...
	331: "User 31",
	332: "User 32",
	336: "Average True Wind Direction",
	337: "Wind Phase",
	338: "Wind Lift",
	380: "Active Perf Mode",
	381: "Gust Bear Away",
	382: "TWS Bear Away",
	383: "Heel Compensation",
	384: "Pilot Net Course",
	385: "Pilot Target Wind Angle",
	386: "Pilot Weather Helm",
	387: "Pilot Mean Heel",
