...
// PgnInfo instances (generated by the pgngen command) describe known
// NMEA 2000 messages.
//
...
// init initializes PgnInfoLookup from pgnList (defined in
// pgninfo_generated.go)
//
//nolint:gochecknoinits // Why: fine
func init() {
...
// IsProprietaryPGN returns true if its argument is in one of the
// proprietary ranges.
//
//nolint:gocritic // Why: if-else -> switch meh
...
//
//nolint:errcheck,gosec // Why: refactor
